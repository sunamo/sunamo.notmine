...
namespace HtmlAgilityPack
{
    ...
    public partial class HtmlDocument
    {
        ...
        public static string HtmlEncodeWithCompatibility(string html, bool backwardCompatibility = true)
        {
            if (html == null)
            {
                ThrowExceptions.Custom(Exc.GetStackTrace(), type, Exc.CallingMethod(),"html");
            }
        ...
        public HtmlCommentNode CreateComment(string comment)
        {
            if (comment == null)
            {
                ThrowExceptions.Custom(Exc.GetStackTrace(), type, Exc.CallingMethod(),"comment");
            }
        ...
        public Encoding DetectEncoding(Stream stream, bool checkHtml)
        {
            ...
            if (stream == null)
            {
                ThrowExceptions.Custom(Exc.GetStackTrace(), type, Exc.CallingMethod(),"stream");
            }
        ...
        public Encoding DetectEncoding(TextReader reader)
        {
            if (reader == null)
            {
                ThrowExceptions.Custom(Exc.GetStackTrace(), type, Exc.CallingMethod(),"reader");
            }
        ...
        public HtmlNode GetElementbyId(string id)
        {
            if (id == null)
            {
                ThrowExceptions.Custom(Exc.GetStackTrace(), type, Exc.CallingMethod(),"id");
            }
            if (Nodesid == null)
            {
                ThrowExceptions.Custom(Exc.GetStackTrace(), type, Exc.CallingMethod(),HtmlExceptionUseIdAttributeFalse);
            }
        ...
        public void Save(Stream outStream, Encoding encoding)
        {
            if (outStream == null)
            {
                ThrowExceptions.Custom(Exc.GetStackTrace(), type, Exc.CallingMethod(),"outStream");
            }
            if (encoding == null)
            {
        ...
        public void Save(TextWriter writer)
        {
            if (writer == null)
            {
                ThrowExceptions.Custom(Exc.GetStackTrace(), type, Exc.CallingMethod(),"writer");
            }
        ...
        private void ReadDocumentEncoding(HtmlNode node)
        {
            ...
            if (!string.IsNullOrEmpty(charset))
            {
                ...
                {
                    ThrowExceptions.Custom(Exc.GetStackTrace(), type, Exc.CallingMethod(),_declaredencoding.ToString());
                }
