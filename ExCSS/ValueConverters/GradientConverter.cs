...
namespace ExCSS
{
    ...
    public abstract class GradientConverter : IValueConverter
    {
    ...
    public sealed class LinearGradientConverter : GradientConverter
    {
    ...
    public sealed class RadialGradientConverter : GradientConverter
    {
        private readonly IValueConverter _converter;
