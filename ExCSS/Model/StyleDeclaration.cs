...
namespace ExCSS
{
    public sealed class StyleDeclaration : StylesheetNode, IProperties
    {
        ...
        public StyleDeclaration(StylesheetParser parser) : this(null, parser)
        {
        }

        public StyleDeclaration() : this(null, null)
        {
        }

        public StyleDeclaration(Rule parent) : this(parent, parent.Parser)
        {
        }
        ...
        public void SetDeclarations(IEnumerable<Property> decls)
        {
            ChangeDeclarations(decls, m => false, (o, n) => !o.IsImportant || n.IsImportant);
        }

        public void UpdateDeclarations(IEnumerable<Property> decls)
        {
