...
namespace ExCSS
{
    ...
    {
        public static readonly StylesheetParser Default = new StylesheetParser();
        ...
        public KeyframeSelector ParseKeyframeSelector(string keyText)
        {
            return Parse(keyText, (b, t) => Tuple.Create(b.CreateKeyframeSelector(ref t), t));
        }

        public SelectorConstructor GetSelectorCreator()
        {
        ...
        public Stylesheet Parse(TextSource source)
        {
        ...
        public async Task<Stylesheet> ParseAsync(Stylesheet sheet, TextSource source)
        {
        ...
        public TokenValue ParseValue(string valueText)
        {
        ...
        public Property ParseDeclaration(string declarationText)
        {
            return Parse(declarationText, (b, t) => Tuple.Create(b.CreateDeclaration(ref t), t));
        }

        public List<Medium> ParseMediaList(string mediaText)
        {
        ...
        public List<DocumentFunction> ParseDocumentRules(string documentText)
        {
            return Parse(documentText, (b, t) => Tuple.Create(b.CreateFunctions(ref t), t));
        }

        public Medium ParseMedium(string mediumText)
        {
            return Parse(mediumText, (b, t) => Tuple.Create(b.CreateMedium(ref t), t));
        }

        public KeyframeRule ParseKeyframeRule(string ruleText)
        {
            return Parse(ruleText, (b, t) => b.CreateKeyframeRule(t));
        }

        public void AppendDeclarations(StyleDeclaration style, string declarations)
        {
