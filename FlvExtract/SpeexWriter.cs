...
{
    public class SpeexWriter : IAudioWriter
    {
static Type type = typeof(SpeexWriter);
        ...
        {
            ThrowExceptions.Custom(Exc.GetStackTrace(), type, Exc.CallingMethod(),ExtractionException("Invalid Speex data.");
        }
