...
namespace FlvExtract
{
    ...
    {
static Type type = typeof(FLVFile);
        ...
        public FLVFile(Stream inputStream, Stream audioOutputStream = null, Stream videoOutputStream = null)
        {
            ...
            if (audioOutputStream == null && videoOutputStream == null)
                ThrowExceptions.Custom(Exc.GetStackTrace(), type, Exc.CallingMethod(),ArgumentNullException();
        ...
        private IVideoWriter GetVideoWriter(uint mediaInfo)
        {
            ...
            ThrowExceptions.Custom(Exc.GetStackTrace(), type, Exc.CallingMethod(),ExtractionException("Unable to extract video (" + typeStr + " is unsupported).");
        }
