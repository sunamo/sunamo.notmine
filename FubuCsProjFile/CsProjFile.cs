...
namespace FubuCsProjFile
{
    ...
    <AssemblyName>MyProject</AssemblyName>
        ...
        {
            var l = _project.PropertyGroups as IList<MSBuildPropertyGroup>;
            var il = _project.PropertyGroups as IList;
            var ic = _project.PropertyGroups as ICollection;
        }

        public IEnumerable<Guid> ProjectTypes()
        {
            var raws =
                _project.PropertyGroups.Select(x => x.GetPropertyValue(cProjectTypeGuids)).Where(x => x.IsNotEmpty());
